...
interface KnowledgeDocument { id: string; title: string; content: string; category: KnowledgeCategory; tags: string[]; relatedDocumentIds: string[]; version: number; updatedAt: string; }
...
export function KnowledgeBasePage() {
  ...
  async function saveDocument(event: FormEvent) {
    ...
    const body = { title: selected.title, content: selected.content, category: selected.category, tags: selected.tags, relatedDocumentIds: selected.relatedDocumentIds };
    try {
